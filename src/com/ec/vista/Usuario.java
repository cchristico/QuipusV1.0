...
public class Usuario extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("ProyectoQuipusPU").createEntityManager();
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                Usuario.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Usuario.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                Usuario.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Usuario.this.deleteButtonActionPerformed(evt);
            }
        }
